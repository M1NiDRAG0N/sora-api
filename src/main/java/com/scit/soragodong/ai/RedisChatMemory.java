...
public class RedisChatMemory implements ChatMemory {
    ...
    public void add(String conversationId, List<Message> messages) {
        ...
        for (Message message : messages) {
            try {
                String type = message.getMessageType().name(); // USER, ASSISTANT
                String content = message.getText();
                String json = objectMapper.writeValueAsString(new MessageRecord(type, content));
    ...
    record MessageRecord(String type, String content) {}
}
